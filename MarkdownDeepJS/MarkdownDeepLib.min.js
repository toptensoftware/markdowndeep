...
del:d|l,img:d|l,li:f,dd:f,dt:f,td:f,th:f,legend:f,address:f,hr:d|t,"!":d|t,head:d};delete d;delete l;delete t;function C
...
h.push(c);break}break;case"`":c=this.aF();break;case"[":case"!":var u=b.by;c=this.aI();if(c==null)b.by=u;break;case"<":
...
b.W(),r);b.a5(1);n=b.by;if(b.aW("(")){var u=ar(b,null,this.bw.ExtraMode);if(u==null)return null;b.bd();if(!b.aW(")"))
return null;return this.O(o,new am(u,m))}if(!b.aW(" "))b.aW("\t");if(b.Y()){b.aZ();b.a8()}var c=null;if(b.H()=="["){b.a5
...
".")&&b.a8()){c.R=b.by;return 10}b.by=c.R}if(e=="["){if(this.bw.ExtraMode&&b.F(1)=="^"){var u=b.by;b.a5(2);var p=b.a4();
if(p!=null&&b.aW("]")&&b.aW(":")){b.a8();c.R=b.by;c.X=p;return 28}b.by=u}var q=an(b,this.bw.ExtraMode);if(q!=null){this.
...
this.bw.SafeMode&&!h.at())m=true;var p=h.ap();if((p&1)==0)return false;if((p&4)!=0||h.closed){b.a8();b.aZ();c.N=b.by-c.R
;c.v=m?16:15;return true}if((p&2)!=0){b.a8();if(!b.Y())return false}if(this.bw.ExtraMode){var n=this.ar(h);if(n!=0)
return this.aK(b,c,h,n)}var k=null,s=this.bw.ExtractHeadBlocks&&h.name.toLowerCase()=="head",u=b.by,o=1;while(!b.J()){
if(!b.Z("<"))break;var r=b.by,j=ag(b);if(j==null){b.a5(1);continue}if(this.bw.SafeMode&&!j.at())m=true;if(j.closed)
continue;if(!s&&!j.closing&&this.bw.ExtraMode&&!m){var n=this.ar(j);if(n!=0){var q=this.T(g);if(this.aK(b,q,j,n)){if(k==
null)k=[];if(r>g){var e=this.T(g);e.E=b.E;e.v=15;e.R=g;e.N=r-g;k.push(e)}k.push(q);g=b.by;continue}else this.ai(q)}}if(j
.name==h.name&&!j.closed)if(j.closing){o--;if(o==0){b.a8();b.aZ();if(m){c.v=16;c.a3(b.by);return true}if(k!=null){if(b.
by>g){var e=this.T(g);e.E=b.E;e.v=15;e.R=g;e.N=b.by-g;k.push(e)}c.v=23;c.a3(b.by);c.C=k;return true}if(s){var v=b.E.
substr(u,r-u);this.bw.HeadBlockContent=this.bw.HeadBlockContent+ay(v)+"\n";c.v=15;c.R=b.bK;c.contentEnd=b.bK;c.ay=b.bK;
return true}c.v=15;c.N=b.by-c.R;return true}}else o++}return 0};a.M=function(b){var m=b[0].v,u=b[0].aq();for(var c=1;c<b
.length;c++){if(b[c].v==12&&(b[c-1].v==12||b[c-1].v==m)){b[c-1].a3(b[c].ao());this.ai(b[c]);b.splice(c,1);c--;continue}
if(b[c].v!=13&&b[c].v!=0){var s=b[c].aq();if(s>u){b[c].v=13;var v=b[c].ao();b[c].R=b[c].ay+s;b[c].a3(v)}}}var g=this.T(0
