...
substr(this.aa);this.aa=this.ad+b.length};function r(b,d,e,f){if(b<d)return b;return b<d+e?d:b+f-e}a.I=function(b,d,e){
this.af=this.af.substr(0,b)+e+this.af.substr(b+d);this.ad=r(this.ad,b,d,e.length);this.aa=r(this.aa,b,d,e.length)};a.t=
...
length)==b};a.U=function(){while(v(this.af.charAt(this.ad)))this.ad++;while(this.aa>this.ad&&v(this.af.charAt(this.aa-1)
))this.aa--};a.E=function(b){return b==0||x(this.af.charAt(b-1))};a.p=function(b){while(b>0&&!x(this.af.charAt(b-1)))b--
;return b};a.r=function(b){while(b<this.af.length&&!x(this.af.charAt(b)))b++;return b};a.w=function(b){return this.P(
this.r(b))};a.T=function(b){while(b<this.af.length&&v(this.af.charAt(b)))b++;return b};a.P=function(b){if(this.af.substr
(b,2)=="\r\n")return b+2;if(x(this.af.charAt(b)))return b+1;return b};a.R=function(b){if(b>2&&this.af.substr(b-2,2)==
"\r\n")return b-2;if(b>1&&x(this.af.charAt(b-1)))return b-1;return b};a.M=function(){this.ad=this.p(this.ad);if(!this.E(
this.aa))this.aa=this.P(this.r(this.aa))};a.S=function(b){while(b>0&&v(this.af.charAt(b-1)))b--;return b};a.Q=function(b
){while(v(this.af.charAt(b)))b++;return b};a.L=function(){this.ad=this.S(this.ad);this.aa=this.Q(this.aa)};a.o=function(
){var d=this.t(),b=d.match(/\n[ \t\r]*\n/);if(b){alert("Please make a selection that doesn't include a paragraph break")
;return false}return true};a.B=function(f){var e=this.af.length;for(var b=f;b<e;b++){var d=this.af[b];if(x(d))
return true;if(!v(this.af.charAt(b)))return false}return true};a.y=function(b){var e=b;b=this.p(b);if(this.B(b))return b
...
else return{ab:"1",ah:b[0].length}};function l(b,e){if(!b.setSelectionRange)q=true;this.Y=null;this.ai=[];this.ag=0;this
.ae=3;this.Z=new MarkdownDeep.Markdown();this.Z.SafeMode=false;this.Z.ExtraMode=true;this.ac=b;this.W=e;this.X=null;var 
f=this;s(b,"keyup",function(){f.H()});s(b,"keydown",function(d){return f.F(d)});s(b,"paste",function(){f.H()});s(b,
"input",function(){f.H()});s(b,"mousedown",function(){f.O(3)});this.H()}var a=l.prototype,c=l.prototype;a.F=function(b){
var d=null,f=true;if(b.ctrlKey||b.metaKey){var e=String.fromCharCode(b.charCode||b.keyCode);if(!this.disableShortCutKeys
&&w[e]!=undefined){this.InvokeCommand(w[e]);return u(b)}switch(e){case"V":d=1;break;case"X":d=2;break}}else switch(b.
keyCode){case 9:if(!this.disableTabHandling){this.InvokeCommand(b.shiftKey?"untab":"tab");return u(b)}else d=1;break;
...
"indented_newline");this.ai.pop();this.ag--;return u(b)}};a.O=function(b){if(this.ae==b)return;this.ae=b;this.n()};a.n=
