...
var MarkdownDeep;(function(a){if(typeof module!=="undefined"&&module.exports)module.exports=a;else if(typeof define===
"function")define(a);else MarkdownDeep=a})(new(function(){function S(b,e){if(b.indexOf!==undefined)return b.indexOf(e);
for(var c=0;c<b.length;c++)if(b[c]===e)return c;return-1}function i(){this.bz=new E(this);this.bC=[];this.bE=new F();
this.bF=new F()}i.prototype={SafeMode:false,ExtraMode:false,MarkdownInHtml:false,AutoHeadingIDs:false,UrlBaseLocation:
null,UrlRootLocation:null,NewWindowForExternalLinks:false,NewWindowForLocalLinks:false,NoFollowLinks:false,
